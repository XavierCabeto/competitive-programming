/*
	- Just a simpler (to code, not to understand) way to calculate p(l) than https://github.com/XavierCabeto/competitive-programming/blob/master/CodeForces/CF633-D12-E(1).cpp
